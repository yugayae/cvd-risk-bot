...
MESSAGES = {
    "ru": {
        ...
        "ask_cholesterol": (
            "📊 Уровень холестерина\n\n"
            "Если у вас есть результаты анализов — ориентируйтесь на них.\n"
            "Если точных данных нет, выберите вариант, который наиболее близко описывает вашу ситуацию:\n\n"
            "Этот вопрос используется только для ориентировочной оценки риска и не заменяет лабораторные исследования.\n\n"
            "🟢 Норма — ранее анализы были нормальными или повышений не отмечалось.\n\n"
            "🟡 Выше нормы — врач когда-либо говорил о пограничных значениях или рекомендовал изменить питание/образ жизни.\n\n"
            "🔴 Высокий — врач сообщал о выраженном повышении холестерина или рекомендовал медикаментозное лечение."
        ),
        "ask_glucose": (
            "🍭 Уровень глюкозы крови\n\n"
            "Если у вас есть лабораторные показатели — ориентируйтесь на них.\n"
            "При отсутствии точных данных выберите наиболее подходящий вариант:\n\n"
            "Этот вопрос используется только для ориентировочной оценки риска и не заменяет лабораторные исследования.\n\n"
            "🟢 Норма — ранее показатели сахара были нормальными, диабет не диагностировался.\n\n"
            "🟡 Выше нормы — врач отмечал пограничные значения или рекомендовал наблюдение и контроль питания.\n\n"
            "🔴 Высокий — ранее сообщалось о значительном повышении сахара или назначалось лечение для его снижения."
        ),
